...
INPUTDIR="/pnfs/annie/persistent/users/moflaher/deapfit_inputs/R1214_R1284"
...
OUTFILEBASE="R1214_to_R1284_PMTStability";
...
#INPUTFILE="TranspGainHVsR1279S0_1800V_PMTStability_Run0.root"
#INPUTFILE="TranspGainHVsR1280S0_1900V_PMTStability_Run0.root"
#INPUTFILE="TranspGainHVsR1281S0_2000V_PMTStability_Run0.root"
#INPUTFILE="TranspGainHVsR1282S0_2050V_PMTStability_Run0.root"
#INPUTFILE="TranspGainHVsR1283S0_2100V_PMTStability_Run0.root"
#INPUTFILE="TranspGainHVsR1284S0_2200V_PMTStability_Run0.root"

INPUTFILES=("R1227S0_1050V_PMTStability_Run0.root" "R1214S1_1100V_PMTStability_Run0.root" "R1228S0_1150V_PMTStability_Run0.root" "R1215S0_1200V_PMTStability_Run0.root" "R1229S0_1250V_PMTStability_Run0.root" "R1216S0_1300V_PMTStability_Run0.root" "R1230S0_1350V_PMTStability_Run0.root" "R1217S0_1400V_PMTStability_Run0.root" "R1231S0_1450V_PMTStability_Run0.root" "R1218S0_1500V_PMTStability_Run0.root" "R1219S0_1600V_PMTStability_Run0.root" "R1220S0_1700V_PMTStability_Run0.root" "R1232S0_1800V_02Range_PMTStability_Run0.root" "R1233S0_1900V_02Range_PMTStability_Run0.root" "TranspGainHVsR1279S0_1800V_PMTStability_Run0.root" "TranspGainHVsR1280S0_1900V_PMTStability_Run0.root" "TranspGainHVsR1281S0_2000V_PMTStability_Run0.root" "TranspGainHVsR1282S0_2050V_PMTStability_Run0.root" "TranspGainHVsR1283S0_2100V_PMTStability_Run0.root" "TranspGainHVsR1284S0_2200V_PMTStability_Run0.root")
INPUTFILELIST=("deap_files_list.txt")
...
# copy the input file list (specifies which histograms in these files to fit and their true voltages)
echo "copying the input file ${INPUTDIR}/${INPUTFILELIST}"
ifdh cp -D ${INPUTDIR}/${INPUTFILELIST} .
if [ ! -f ${INPUTFILELIST} ]; then echo "input file list not found!!!"; exit 15; fi
...
./deapfit --start ${STARTINDEX} --numhistos ${HISTOGRAMS_PER_JOB} ${INPUTFILELIST} 2>&1 | tee ${OUTLOG}
